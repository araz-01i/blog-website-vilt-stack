...
defineProps({
    ...
    breadcrumbs: {
        type: Array,
        default: () => [{ name: 'Create', href: route('blog-posts.create'), current: true }],
    },
});
            ...
            <div class="flex flex-col gap-2 border-b border-gray-200 pb-4 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <h1 class="text-2xl font-bold text-gray-900 sm:text-3xl dark:text-white">Create New Blog Post</h1>
                    </div>
                </div>
            </div>
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="rounded-lg bg-white p-6 shadow-sm dark:bg-gray-900">
                            <div class="flex flex-col gap-3">
                                ...
                                <button
                                    type="submit"
                                    class="inline-flex items-center justify-center rounded-lg bg-emerald-500 px-5 py-3 text-sm font-medium text-white transition-colors hover:bg-emerald-600 focus:ring-2 focus:ring-emerald-400 focus:ring-offset-2 focus:outline-none active:bg-emerald-700 disabled:pointer-events-none disabled:opacity-50 sm:text-base"
                                    :disabled="form.processing"
                                >
                                    {{ form.processing ? 'Creating...' : 'Publish Blog Post' }}
                                </button>
                            </div>
                        </div>
                    </div>
